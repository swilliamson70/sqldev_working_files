...
-- Gift Dates
  p_giving_start_date       DATE := to_date('01-JAN-2019','DD-MON-YYYY');  -- parm_DT_GivingStart
  p_giving_end_date         DATE := to_date('31-DEC-2019','DD-MON-YYYY'); -- parm_DT_GivingEnd
  p_ignore_gift_dates       VARCHAR2(10) := '1'; -- parm_DB_Ignore_Gift_Dates
