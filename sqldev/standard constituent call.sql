declare
  v_activity_codes          VARCHAR2(60); -- parm_MC_ActivityCode
  v_all_activities          VARCHAR2(10) := '1'; -- parm_CB_AllActivities
  v_activity_years          VARCHAR2(60); -- parm_lb_activity_years
  v_all_years               VARCHAR2(10) := '1'; -- cb_activity_years
  v_leadership_codes        VARCHAR2(60); -- parm_MC_leadership
...
--Degree Info
  ...
  v_grad_years              VARCHAR2(60); -- parm_LB_GradYear
  v_all_grad_years          VARCHAR2(10) := '1'; -- parm_CB_GradYears
  v_degrees                 VARCHAR2(60); -- parm_MC_Degrees
  v_all_degrees             VARCHAR2(10) := '1'; -- parm_CB_AllDegrees
  v_majors                  VARCHAR2(60); -- parm_MC_Major
  v_all_majors              VARCHAR2(10) := '1'; -- parm_CB_AllMajors

--Demographics
  v_deceased                VARCHAR2(10) := '1'; -- parm_CB_deceased
  v_veteran                 VARCHAR2(60) := 'All'; -- lb_veteran
  v_prim_spouse_unmarried   VARCHAR2(10) := '1'; -- parm_CB_PrimSpouse_Unmarried
  v_household_ind           VARCHAR2(60); -- parm_LB_HouseholdInd
  v_ignore_household_ind    VARCHAR2(10) := '1'; -- parm_CB_HouseholdInd
  v_zipcodes                VARCHAR2(60); -- parm_MC_ZipCode
  v_all_zipcodes            VARCHAR2(10) := '1'; -- parm_CB_AllZipCodes
  v_ignore_zip              VARCHAR2(10) := '1'; -- parm_CB_ignore_zip_use_state
  v_state_codes             VARCHAR2(60); -- parm_MC_StateCode
  v_city                    VARCHAR2(30); -- parm_EB_City
  v_use_city                VARCHAR2(10) := '1'; -- parm_CB_enter_name
  v_county_codes            VARCHAR2(60); -- parm_MC_CountryCode
  v_all_counties            VARCHAR2(10) := '1'; -- parm_CB_AllCountyCodes

--Donor Information
  v_donor_cats              VARCHAR2(60); -- parm_MC_DonorCats
  v_all_donor_cats          VARCHAR2(10) := '1'; -- parm_CB_AllDonorCats
  v_gift_capacity           VARCHAR2(60); -- parm_LB_GiftCapRange
  v_all_gift_capacities     VARCHAR2(10) := '1'; -- parm_CB_AllGCrranges
  v_wealth_engine_desg      VARCHAR2(60); -- parm_LB_WealthEngineDesg
  v_all_wealth_engine_desg  VARCHAR2(10) := '1'; -- parm_CB_AllWEdesignations
  v_spec_purpose_types      VARCHAR2(60); -- parm_MC_SP_Types
  v_all_spec_purpose_types  VARCHAR2(10) := '1'; -- parm_CB_SP_Types
  v_spec_purpose_groups     VARCHAR2(60); -- parm_MC_SP_Groups
  v_all_spec_purpose_groups VARCHAR2(10) := '1'; -- parm_CB_SP_Groups
  v_exclusion_codes         VARCHAR2(60); -- parm_MC_ExclusionCode
  v_all_exclusion_codes     VARCHAR2(10) := '1'; -- parm_CB_AllExclusions
  v_mail_codes              VARCHAR2(60); -- parm_MC_mail_codes
  v_all_mail_codes          VARCHAR2(10) := '1'; -- parm_CB_AllMailCodes

-- Gift Dates
  v_giving_start_date       DATE := to_date('01-JAN-2019','DD-MON-YYYY');  -- parm_DT_GivingStart
  v_giving_end_date         DATE := to_date('31-DEC-2019','DD-MON-YYYY'); -- parm_DT_GivingEnd
  v_ignore_gift_dates       VARCHAR2(10) := '1'; -- parm_DB_Ignore_Gift_Dates
